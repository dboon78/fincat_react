...
import { FaCalendar, FaHome, FaMoneyBill, FaTable } from "react-icons/fa";
interface Props {}

const Sidebar = (props: Props) => {
  return (
    <nav className="fixed  py-4 px-6 top-16 bottom-0 w-64 bg-white shadow-xl left-0 flex-row flex-nowrap md:z-10 z-9999 transition-all duration-300 ease-in-out transform md:translate-x-0 -translate-x-full">
